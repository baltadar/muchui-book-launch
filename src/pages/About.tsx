    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-20 md:py-32">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-muted-foreground leading-relaxed text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-light mb-8 text-center">Connect with Dr. Manyara</h2>
