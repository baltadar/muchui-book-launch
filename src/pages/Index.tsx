      ...
      <section className="border-t border-border py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-muted-foreground leading-relaxed mb-16 text-center max-w-3xl mx-auto">
            ...
            <h3 className="text-3xl md:text-4xl font-light mb-8 text-center">Connect with Dr. Manyara</h3>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 text-sm text-muted-foreground">
              <a href="mailto:antony@yaafrika.org" className="flex items-center gap-2 hover:text-foreground transition-colors">
